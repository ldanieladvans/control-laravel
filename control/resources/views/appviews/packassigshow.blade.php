...
<div class="container">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Asignación Cuenta-Paquete</h2>
                  ...
                  <div class="x_content">
                    <button type="button" onclick="location.href = 'accpack/create';" class="btn btn-primary">Agregar</button>
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td class=" last" width="13%">
                                      ...
                                      <div class="btn-group">
                                          <div class="btn-group">
                                              <button onclick="location.href = 'accpack/{{$appcta->id}}/edit';" class="btn btn-xs" data-placement="left" title="Editar" style=" color:#790D4E "><i class="fa fa-edit fa-2x"></i> </button>
                                          </div>
                                        ...
                                        <div class="btn-group">
                                              ...
                                              {{ Form::open(['route' => ['accpack.destroy', $appcta], 'class'=>'pull-right']) }}
